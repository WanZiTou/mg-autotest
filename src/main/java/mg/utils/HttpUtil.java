...
public class HttpUtil {
    ...
    public static String qadGet(String url) {
        String result = null;
    ...
    public static String qadGet(String url, Map<String, String> params) {
    ...
    public static String qadPost(String url, Map<String, String> map) {
    ...
    public static String qadPost(String url, File file) {
        String result = null;
        HttpPost httpPost = new HttpPost(url);
    ...
    public static String qadPost(String url, String jsonStr) {
        String result = null;
    ...
    public static String qadPost(String url) {
        String result = null;
 ...
 /**
     * qad a POST request to itcuties.com
     * @param query
     * @throws IOException
     */
    public String echoCuties(String query) throws IOException {
        ...
        // This is the data that is going to be qad to itcuties.com via POST request
...
//	        try {
//
//	           // System.out.println(new POSTqaderExample().echoCuties("Hi there!"));
//
